const nl = {
    ...
    home: {
        ...
        fallbackName: "lezer",
        subtitle: "Hier is je leesoverzicht van %{month}",
    ...
    discussion: {
        ...
        noQuestionsTitle: "Nog geen discussievragen",
        noQuestionsText: "Start met een paar voorbeeldvragen of schrijf zelf een vraag voor de bespreking.",
        writeYourself: "Zelf schrijven",
        usePresets: "Presets kiezen",
        useStarterQuestions: "Gebruik startvragen",
        addSelectedQuestions: "%{count} vragen toevoegen",

        presetStarterTitle: "Start",
        presetStarterDescription: "Laagdrempelige vragen om het gesprek makkelijk op gang te brengen.",
        presetDeepDiveTitle: "Diepgang",
        presetDeepDiveDescription: "Vragen voor clubs die iets meer willen praten over thema’s, keuzes en betekenis.",
        presetSpicyTitle: "Spicy",
        presetSpicyDescription: "Iets lossere vragen voor een minder brave boekbespreking.",

        presetQuestionFirstImpression: "Wat was je eerste indruk van het boek?",
        presetQuestionMostMemorable: "Welk moment bleef het meest hangen?",
        presetQuestionFavoriteCharacter: "Welk personage begreep je het best, en waarom?",
        presetQuestionPace: "Wat vond je van het tempo van het verhaal?",
        presetQuestionRecommend: "Zou je dit boek aanraden aan iemand anders?",

        presetQuestionStrongestTheme: "Welk thema vond je het sterkst terugkomen?",
        presetQuestionCharacterChange: "Veranderde je mening over een personage tijdens het lezen?",
        presetQuestionEndingMeaning: "Wat denk je dat de schrijver wilde zeggen met het einde?",
        presetQuestionDisagreeChoice: "Was er een keuze van een personage waar je het niet mee eens was?",
        presetQuestionSceneSummary: "Welke scène zegt volgens jou het meeste over het boek?",

        presetQuestionBlockCharacter: "Welk personage zou je direct blocken?",
        presetQuestionBadChoice: "Welke keuze in dit boek was echt dramatisch slecht?",
        presetQuestionRealVillain: "Wie was de echte villain?",
        presetQuestionTiktokScene: "Welke scène zou TikTok compleet laten ontploffen?",
        presetQuestionTherapyCharacter: "Welk personage had therapie nodig?",

        noPresetSelectedTitle: "Geen vragen gekozen",
        noPresetSelectedMessage: "Selecteer eerst één of meer vragen.",
        noNewPresetQuestionsTitle: "Geen nieuwe vragen",
        noNewPresetQuestionsMessage: "Deze vragen staan al in de lijst.",
        addPresetQuestionsErrorTitle: "Vragen toevoegen mislukt",
        addPresetQuestionsErrorMessage: "Er ging iets mis tijdens het toevoegen van de preset-vragen.",
    },
    planMeeting: {
